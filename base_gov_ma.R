...
setwd("C:\\Users\\jvoig\\OneDrive\\Documentos\\Colab\\COLAB\\GovMA")
...
recursos1 <- recursos %>%
  ...
  select(protocolo, recurso_1, resposta_recurso_1, data_recurso_1, data_resposta_recurso_1 )
...
recursos2 <- recursos %>%
  ...
  select(protocolo, recurso_2, resposta_recurso_2, data_recurso_2, data_resposta_recurso_2 )    
...
recursos3 <- recursos %>%
  ...
  select(protocolo, recurso_3, resposta_recurso_3, data_recurso_3, data_resposta_recurso_3 )  
